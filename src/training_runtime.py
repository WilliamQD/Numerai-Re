...
from artifact_contract import FEATURES_FILENAME
from benchmarks import download_benchmark_parquets
from config import TrainRuntimeConfig
from data_loading import load_split_numpy
from era_utils import era_to_int
from feature_sampling import sample_features_for_seed
from numerapi_datasets import resolve_split_parquet
from train_benchmark_data import load_and_align_benchmarks
...
def fit_lgbm(cfg: TrainRuntimeConfig, lgb_params: dict[str, object], data: LoadedData, seed: int) -> FitResult:
	from training_tuning import best_corr_iteration as _best_corr_iteration
	from training_tuning import corr_scan_iterations as _corr_scan_iterations
